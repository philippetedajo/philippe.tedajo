...
export default function Home() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-neutral-50 font-sans dark:bg-black px-5 sm:px-10 max-w-2xl mx-auto">
      <div className="flex flex-col font-medium mt-12 sm:mt-24">
        <Image
          alt="avatar"
          src="/avatar.jpeg"
        ...
        <p className="leading-[25px] mt-4 text-neutral-500 dark:text-neutral-400 w-11/12">
          I’m passionate about building things. Web apps, desktop tools, mobile
          experiences, video-processing pipelines, ai agents, and anything
          developers might find useful. When the day ends, i’m usually still
          creating or exploring new ideas.
        </p>
        ...
        <h3 className="mt-20 mb-40 text-sm text-neutral-400 mb-2 lowercase">
          © {new Date().getFullYear()} Philippe Tedajo.
        </h3>
      </div>

      <div className="absolute top-0 right-20 w-80 h-80 lg:block hidden">
